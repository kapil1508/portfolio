export const Bio = {
  ...
  github: "https://github.com/kapil1508",
  resume:
...
export const experiences = [
  {
    id: 0,
    img: "https://www.sponsogram.in/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo.7a7f762a.png&w=256&q=75",
    ...
    doc: "https://drive.google.com/file/d/10d42Fcvrb3BkcsEJuOAEZZFUVNcKdUJQ/view?usp=drive_link",
  },
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Developed a full-stack, dynamic, and responsive web application using Multer, Express.js, React.js, and Node.js to streamline document conversion. The application enables users to upload DOC files and convert them into PDFs seamlessly. Multer is utilized for efficient file handling, ensuring smooth and secure document uploads. The user interface, built with React.js, provides an intuitive experience across various devices. Additionally, Express.js and Node.js power the backend, optimizing performance and ensuring secure processing of files.",
    image:
      "_",
    tags: [
      "React Js",
    ...
    category: "web app",
    github: "https://github.com/Anuj0704/ConvoApp",
    webapp: "https://word-pdf-conv.netlify.app/",
  },
]